...
// Page
function handle_page_templates($template)
{
  if (is_page_template('home.php')) {
    $template = locate_template('templates/page/home.php');
  } elseif (is_page_template('custom-template-community.php')) {
    $template = locate_template('templates/page/community.php');
  } elseif (is_page_template('custom-template-library.php')) {
    $template = locate_template('templates/page/library.php');
  } else {
    $template = locate_template('templates/page/page.php');
  }

  return $template;
}
add_filter('page_template', 'handle_page_templates');
...
// Search
function handle_search_templates($template)
{
  $template = locate_template('templates/search/search.php');

  return $template;
}
add_filter('search_template', 'handle_search_templates');
