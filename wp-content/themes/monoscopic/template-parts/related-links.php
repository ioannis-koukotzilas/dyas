  ...
  <div class="related-links">
    <div class="wrapper">
      ...
      if ($post_type == 'tools_services_post') {
        $title = esc_html__('Related Tools and Services Links', 'monoscopic');
      } elseif ($post_type == 'community_post') {
        $title = esc_html__('Related Community Links', 'monoscopic');
      } elseif ($post_type == 'library_post') {
        $title = esc_html__('Related Library Links', 'monoscopic');
      } elseif ($post_type == 'page') {
        $title = esc_html__('Related Page Links', 'monoscopic');
      } else {
