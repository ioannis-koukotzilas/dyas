...
<main class="site-main archive community-archive">
    ...
    <?php if (have_posts()) : ?>
      ...
      <header class="page-header">
        <div class="wrapper">
          ...
          <?php if (get_field('community_archive_description', 'option')) : ?>
            <div class="description"><?php the_field('community_archive_description', 'option'); ?></div>
          <?php endif; ?>
        </div>
      </header>
